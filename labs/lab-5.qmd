...
Intuitively, if r=1 or −1, then $R^2$=1, indicating the model perfectly fits the data.
...
Link your teammates with the assignment when you submit to Gradescope. If you're unsure how, please ask a member of the teaching team.
:::
...
- All binary operators should be surrounded by space. For example `x + y` is appropriate.
`x+y` is not.
:::
