...
::: callout-important
This lab is **not a part of your grade in this course**.
You should still submit your completed lab to Gradescope to practice submitting to Gradescope and receive feedback.
Since this lab precedes class lecture, you may be unable to complete the lab until next week.
:::

This lab will introduce you to the course computing workflow.
The main goal is to demo R and RStudio, which we will be using throughout the course both to learn the statistical concepts discussed in the course and to analyze real data and come to informed conclusions.
...
-   Go to the course organization at [github.com/sta199-sp23-1](https://github.com/sta199-sp23-1) organization on GitHub.
...
**This lab is not graded** but you should still submit it to Gradescope to practice marking pages and receive feedback on workflow/formatting.
Remember, you must also be sure to commit and push all of your changes (nothing should be left in the Git pane) to your repo.
