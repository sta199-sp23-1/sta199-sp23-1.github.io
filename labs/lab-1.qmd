...
-   Go to the [the course organization](https://github.com/sta199-sp23-1) on GitHub.
    Click on the repo with the prefix **lab-01**.
...
There will be periodic reminders in this assignment to **render, commit, and push** your changes to GitHub.
...
3.  Describe what you observe in the plot from the previous exercise.
    In your description, include similarities and differences in the patterns across states.

4.  Now, let's examine the relationship between the same two variables, using a separate plot for each state.
...
We keep repeating this because it's important. So take a moment to make sure you're following along with the instructions around Git.
:::
