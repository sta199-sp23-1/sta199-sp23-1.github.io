...
-   Go to the [sta199-sp23-1](https://www.github.com/sta199-sp23-1) organization on GitHub. Click on the repo with the prefix `lab-2`. It contains the starter documents you need to complete the lab.
