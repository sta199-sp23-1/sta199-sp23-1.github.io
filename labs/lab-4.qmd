...
-   Go to the [sta199-s23-01](https://github.com/sta199-sp23-1) organization on GitHub. Click on the repo with the prefix `lab-04`. It contains the starter documents you need to complete the lab.
