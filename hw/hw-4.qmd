...
::: callout-important
This homework is due Wednesday, March 29th at 5:00pm.
:::
...
4.  Now, using the same `set.seed`, calculate a 95% bootstrap confidence interval for mean race time for races 170 km or longer using 5000 reps. What following characteristics changed compared to the interval created in question 3.
