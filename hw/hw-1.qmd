...
-   Go to the [sta199-sp23](https://github.com/sta199-sp23-1) organization on GitHub. Click on the repo with the prefix `hw-01`. It contains the starter documents you need to complete the homework assignment.

-   Clone the repo and start a new project in RStudio. See the [Lab 0 instructions](/labs/lab-0.html) for details on cloning a repo and starting a new R project.
