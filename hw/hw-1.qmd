...
-   Go to the [sta199-sp23](https://github.com/sta199-sp23-1) organization on GitHub.
...
-   Clone the repo and start a new project in RStudio.
    See the [Lab 0 instructions](/labs/lab-0.html) for details on cloning a repo and starting a new R project.
...
As they browse Zillow listings, they realize some houses have garages and others don't, and they wonder: **Does having a garage make a difference in price?**
