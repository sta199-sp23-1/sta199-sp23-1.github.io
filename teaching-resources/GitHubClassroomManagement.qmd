...
users1 = usernames[1:50]
users2 = usernames[51:100]
users3 = usernames[101:150]
users4 = usernames[151:n]

## edit this:
assignment_template_repo = "ae3"
users_segmented = c(users1, users2, users3, users4)

for (uu in users_segmented) {
ghclass::org_create_assignment(
  org = org,
